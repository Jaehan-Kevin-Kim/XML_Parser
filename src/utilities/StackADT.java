...
/**
 * The StackADT interface. The Stack data structure is based on the Last In
 * First Out principle. A Stack is a linear ADT, which can be accessed only at
...
public interface StackADT<E> extends Serializable {
	 ...
	 * Add) method. Pre-Condition: E is not null. Post-Condition: E is added to the
	...
	/**
	 * Takes the topmost element of the stack. Pre-Condition: Stack is not empty
	...
	/**
	 * Returns the topmost element in the stack without removing it. Pre-Condition:
	 * Stack is not empty Post-Condition: Returns the top most element without
	...
	/**
	 * Returns the 1-based position where an object is on this stack. Pre-Condition:
	 * Stack is not empty. Post-Condition: Returns the position of element.
	 * 
	 ...
	 * Pre-Condition: Stack is not empty. Post-Condition: Removes all the elements
	 * from collection.
	 */
	public void removeAll();

	/**
	 * Tests if the stack is empty. Pre-Condition: - Post-Condition: Returns true if
	 * stack is empty.
	 * 
	 ...
	 * []) method. Pre-Condition: Stack is not empty. Post-Condition: Returns an
	 * array containing elements of the stack.
	 * 
	 ...
	 * java.util.Collection.toArray()method. Pre-Condition: Stack is not empty.
